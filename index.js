...
var div_clothing = document.createElement("div");
var para_clothing = document.createElement("div");
var clothing_images = document.createElement("div");

var div_accessories = document.createElement("div");
var para_accessories = document.createElement("div");
var accessories_images = document.createElement("div");

document.body.appendChild(clothing);

clothing.appendChild(div_clothing);
clothing.appendChild(div_accessories);

div_clothing.appendChild(para_clothing);
div_clothing.appendChild(clothing_images);

div_accessories.appendChild(para_accessories);
div_accessories.appendChild(accessories_images);

para_clothing.innerHTML = "Clothing For Men and Women";
para_accessories.innerHTML = "Accessories For Men and Women";

clothing.classList = "div_styles";

div_clothing.classList = "clothing";
div_accessories.classList = "clothing";
para_clothing.classList = "heading";
para_accessories.classList = "heading";
clothing_images.classList = "clothing_images";
accessories_images.classList = "accessories_images";

for (var x of productList) {
  console.log(x);
  if (!x.isAccessory) {
    var img = document.createElement("img");
    var clothing_desc = document.createElement("div");
    var clothing_images_div = document.createElement("div");
    var clothing_detail = document.createElement("h2");
    var clothing_brand = document.createElement("h4");
    var clothing_rate = document.createElement("h5");
    img.src = x.preview;
    clothing_detail.innerHTML = x.name;
    clothing_brand.innerHTML = x.brand;
    clothing_rate.innerHTML = "Rs" + " " + x.price;
    img.classList = "images_clothing";
    clothing_desc.classList = "image_desc";
    clothing_images_div.classList = "individual_div_image_section";
    clothing_detail.classList = "image_detail";
    clothing_images.appendChild(clothing_images_div);
    clothing_images_div.appendChild(img);
    clothing_images_div.appendChild(clothing_desc);
    clothing_desc.appendChild(clothing_detail);
    clothing_desc.appendChild(clothing_brand);
    clothing_desc.appendChild(clothing_rate);
  } else {
    var img = document.createElement("img");
    var accessories_desc = document.createElement("div");
    var accessories_img_div = document.createElement("div");
    var accessories_details = document.createElement("h2");
    var accessories_brand = document.createElement("h4");
    var accessories_rate = document.createElement("h5");
    img.src = x.preview;
    accessories_details.innerHTML = x.name;
    accessories_brand.innerHTML = x.brand;
    accessories_rate.innerHTML = "Rs" + " " + x.price;
    img.classList = "images_clothing";
    accessories_desc.classList = "image_desc";
    accessories_img_div.classList = "individual_div_image_section";
    accessories_details.classList = "image_detail";
    accessories_images.appendChild(accessories_img_div);
    accessories_img_div.appendChild(img);
    accessories_img_div.appendChild(accessories_desc);
    accessories_desc.appendChild(accessories_details);
    accessories_desc.appendChild(accessories_brand);
    accessories_desc.appendChild(accessories_rate);
  }
}
